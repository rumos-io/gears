// This is a copy and paste, with modifications, of https://github.com/CosmWasm/cosmwasm/blob/v1.1.5/packages/std/src/math/decimal256.rs
...
use cosmwasm_std::{Decimal, Uint512};
