...
// pub trait MessageValueRendererTrait<V, SK: StoreKey>: ValueRendererTrait<V, SK> {}

// pub struct MessageValueRenderer;

// impl<V, SK: StoreKey> MessageValueRendererTrait<V, SK> for MessageValueRenderer {}

// impl<Envelope, SK: StoreKey> ValueRendererTrait<Envelope, SK> for MessageValueRenderer {
//     fn format(
