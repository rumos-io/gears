...
pub trait ClientApplicationTrait: TxHandler + QueryHandler + AuxHandler {}

pub struct ClientApplication<Core: ClientApplicationTrait> {
    app_core: Core,
}

impl<'a, Core: ClientApplicationTrait> ClientApplication<Core> {
