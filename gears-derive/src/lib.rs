    ...
    match data {
        ...
        syn::Data::Enum(enum_data) => {
            ...
            let from_any = enum_data.variants.iter().map(|v| {
                ...
                quote! {
                    if value.type_url.starts_with(#url) {
                        Ok(Self::#ident(proto_messages::cosmos::ibc::protobuf::Any::try_into(value)?))
                    }
                }
            });
            ...
            let gen = quote! {
                ...
                impl From<#name> for proto_messages::cosmos::ibc::protobuf::Any {
                ...
                impl TryFrom<proto_messages::cosmos::ibc::protobuf::Any> for #name {
                    type Error = proto_messages::Error;

                    fn try_from(value: proto_messages::cosmos::ibc::protobuf::Any) -> Result<Self, Self::Error> {
